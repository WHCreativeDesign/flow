/*
  The app registry. v1 apps are stubs — the shell, gesture layer, and bloom
  come first (handoff §7). Icons are stroke paths on a 24×24 viewBox so the
  same path renders in the orb and in the bloomed app header.
*/
